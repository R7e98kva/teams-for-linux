...
module.exports = {
	...
	type: "object",
      ...
      callRecording: {
        ...
        describe: "Call recording configuration. enabled: master switch. mode: 'audio' (WAV), 'video' (WebM screen share), or 'both'. outputDirectory: where recordings are saved (empty uses default download folder).",
        type: "object",
      },
};
