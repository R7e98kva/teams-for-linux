...
>
> **Last Generated**: 2026-03-11T08:55:58.748Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:174`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L174) |
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:200`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L200) |
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:176`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L176) |
| `get-navigation-state` | Request/Response | Get current navigation state (can go back/forward) | [`app/index.js:223`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L223) |
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:205`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L205) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:214`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L214) |
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:198`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L198) |
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:196`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L196) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `call-connected` | Request/Response | Notify when a call is connected | [`app/mainAppWindow/browserWindowManager.js:127`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L127) |
| `call-disconnected` | Request/Response | Notify when a call is disconnected | [`app/mainAppWindow/browserWindowManager.js:129`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mainAppWindow/browserWindowManager.js#L129) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `get-teams-settings` | One-Time Event | Receive Teams settings from renderer to save to file | [`app/menus/index.js:180`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L180) |
| `set-teams-settings` | One-Time Event | Acknowledge settings restoration completion from renderer | [`app/menus/index.js:186`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L186) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `call-recording-chunk` | Event | Receive PCM audio chunks from renderer | [`app/callRecording/index.js:48`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L48) |
| `call-recording-start` | Event | Receive recording start signal with audio parameters | [`app/callRecording/index.js:43`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L43) |
| `call-recording-stop` | Event | Receive recording stop signal | [`app/callRecording/index.js:53`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L53) |
| `call-video-recording-chunk` | Event | Receive encoded WebM video+audio chunks from renderer | [`app/callRecording/index.js:63`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L63) |
| `call-video-recording-start` | Event | Receive video recording start signal with format parameters | [`app/callRecording/index.js:58`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L58) |
| `call-video-recording-stop` | Event | Receive video recording stop signal | [`app/callRecording/index.js:68`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L68) |
