...
>
> **Last Generated**: 2026-06-08T05:28:29.414Z
...
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:284`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L284) |
...
| `get-navigation-state` | Request/Response | Get current navigation state (can go back/forward) | [`app/index.js:307`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L307) |
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:289`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L289) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:298`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L298) |
...
| `unhandled-rejection` | Event | Log renderer-side unhandled promise rejections | [`app/index.js:316`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L316) |
...
| `window-error` | Event | Log renderer-side uncaught window errors | [`app/index.js:336`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L336) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `get-teams-settings` | One-Time Event | Receive Teams settings from renderer to save to file | [`app/menus/index.js:257`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L257) |
| `set-teams-settings` | One-Time Event | Acknowledge settings restoration completion from renderer | [`app/menus/index.js:263`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L263) |
...
| `call-recording-chunk` | Event | Receive PCM audio chunks from renderer | [`app/callRecording/index.js:50`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L50) |
| `call-recording-start` | Event | Receive recording start signal with audio parameters | [`app/callRecording/index.js:45`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L45) |
| `call-recording-stop` | Event | Receive recording stop signal with optional call metadata for file naming | [`app/callRecording/index.js:55`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L55) |
| `call-video-recording-chunk` | Event | Receive encoded WebM video+audio chunks from renderer | [`app/callRecording/index.js:65`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L65) |
| `call-video-recording-start` | Event | Receive video recording start signal with format parameters | [`app/callRecording/index.js:60`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L60) |
| `call-video-recording-stop` | Event | Receive video recording stop signal with optional call metadata for file naming | [`app/callRecording/index.js:70`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/callRecording/index.js#L70) |
| `camera-state-changed` | Event | Publish MQTT status when camera state changes | [`app/mqtt/mediaStatusService.js:27`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mqtt/mediaStatusService.js#L27) |
...
| `microphone-state-changed` | Event | Publish MQTT status when microphone state changes | [`app/mqtt/mediaStatusService.js:29`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mqtt/mediaStatusService.js#L29) |
...
| `screen-sharing-started` | Event | Publish MQTT status when screen sharing starts | [`app/mqtt/mediaStatusService.js:32`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mqtt/mediaStatusService.js#L32) |
| `screen-sharing-stopped` | Event | Publish MQTT status when screen sharing stops | [`app/mqtt/mediaStatusService.js:34`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/mqtt/mediaStatusService.js#L34) |
